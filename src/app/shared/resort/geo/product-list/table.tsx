...
import { getColumns } from '@/app/shared/resort/geo/product-list/columns';
...
export default function GeoTable({ data = [], onEditToggle }: { data: any[], onEditToggle: (booking: any) => void }) {
