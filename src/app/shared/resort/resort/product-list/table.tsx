...
import { getColumns } from '@/app/shared/resort/resort/product-list/columns';
...
export default function ResortTable({ data = [], onEditToggle }: { data: any[], onEditToggle: (booking: any) => void }) {
