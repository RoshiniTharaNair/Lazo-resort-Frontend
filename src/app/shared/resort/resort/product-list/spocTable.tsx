...
import { getColumns } from './spocColumn';
...
export default function SpocTable({ data = [], onEditToggle }: { data: any[], onEditToggle: (spoc: any) => void }) {
        ...
        tableFooter={
          ...
          >
            <Button size="sm" className="dark:bg-gray-300 dark:text-gray-800">
              ...
              {selectedRowKeys.length > 1 ? 'SPOCs' : 'SPOC'}
            </Button>
          </TableFooter>
        }
