...
import { getColumns } from './documentColumn';
...
const filterState = {
  doc_type: '',
  doc_url: '',
  doc_effdate: [null, null],
  poc_name: '',
  poc_cont: '',
  poc_email: '',
};

export default function DocumentTable({ data = [], onEditToggle }: { data: any[], onEditToggle: (document: any) => void }) {
