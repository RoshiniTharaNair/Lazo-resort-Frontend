...
import { getColumns } from '@/app/shared/resort/employees/product-list/columns';
const FilterElement = dynamic(
  () => import('@/app/shared/resort/employees/product-list/filter-element'),
  { ssr: false }
);
...
export default function BookingsTable({ data = [], onEditToggle }: { data: any[], onEditToggle: (booking: any) => void }) {
        ...
        tableFooter={
          ...
          >
            <Button size="sm" className="dark:bg-gray-300 dark:text-gray-800">
              ...
              {selectedRowKeys.length > 1 ? 'Bookings' : 'Booking'}
            </Button>
          </TableFooter>
        }
