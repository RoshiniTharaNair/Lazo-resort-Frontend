...
import { getColumns } from '@/app/shared/resort/special-rates/product-list/columns';

const FilterElement = dynamic(
  () => import('@/app/shared/resort/special-rates/product-list/filter-element'),
  { ssr: false }
);
...
export default function VoidDateTable({ data = [], onEditToggle }: { data: any[], onEditToggle: (voidDate: any) => void }) {
        ...
        tableFooter={
          ...
          >
            <Button size="sm" className="dark:bg-gray-300 dark:text-gray-800">
              ...
              {selectedRowKeys.length > 1 ? 'Void Dates' : 'Void Date'}
            </Button>
          </TableFooter>
        }
