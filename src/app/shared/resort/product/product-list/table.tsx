...
import { getColumns } from '@/app/shared/resort/product/product-list/columns'; // Ensure the import path is correct
const FilterElement = dynamic(
  () => import('@/app/shared/resort/product/product-list/filter-element'),
  { ssr: false }
);
...
export default function ResortRoomTypesTable({ data = [], onEditToggle }: { data: any[], onEditToggle: (roomType: any) => void }) {
