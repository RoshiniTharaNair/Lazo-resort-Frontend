...
import { getColumns } from '@/app/shared/resort/vendor/product-list/columns';
...
export default function VendorsTable({ data = [], onEditToggle }: { data: any[], onEditToggle: (booking: any) => void }) {
