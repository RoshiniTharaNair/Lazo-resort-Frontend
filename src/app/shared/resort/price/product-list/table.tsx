...
import { getColumns } from '@/app/shared/resort/price/product-list/columns';
const FilterElement = dynamic(
  () => import('@/app/shared/resort/price/product-list/filter-element'),
  { ssr: false }
);
...
export default function ProductsTable({ data = [], onEditToggle }: { data: any[], onEditToggle: (price: any) => void }) {
