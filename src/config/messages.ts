export const messages = {
  ...
  roomCategoryIdentifierIsRequired: 'Room Category identifier is required',
  roomTypeIsRequired: 'Room Type is required',
  minimumOccupancyIsRequired: 'Minimum Occupancy is required'
};
